<template>
    <section class="text-white mt-20" id="contact"> 
        ...
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
            <div>
                <p class="text-[#adb7be]">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quam, libero illum, debitis quas ad quibusdam similique, beatae eos soluta corrupti hic? Assumenda mollitia quibusdam, optio perspiciatis veritatis beatae qui aliquam?</p>
            ...
            <form class="flex flex-col p-2" data-aos="zoom-in-up">
                 ...
                 <div class="mb-6">
                    ...
                    <input type="Message" id="message" class="bg-[#111827] placeholder:[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
                    placeholder="Let's talk about ..." name="message">
                 </div>
