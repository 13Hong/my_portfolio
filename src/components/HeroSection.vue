<template>
    <section class="relative w-full" data-aos="zoom-iu-up">
        <div class="absolute top-0 inset-x-0 h-64 flex items-start">
            ...
            <div class="h-20 w-2/3 bg-gradient-to-r from-[#670ccf] blur-2xl opacity-40"></div>
        </div>
            ...
            <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
                <div class="lg:py-6">
                    ...
                    <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Praesentium eius iusto maiores vitae temporibus, facilis eum ipsum debitis mollitia ipsam dicta illum numquam perspiciatis velit quo? Asperiores rem dolore natus?
                    </p>
                    <div class="flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0">
                        ...
                        <button class="border border-primary px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center">
                            <div class="hover:scale-105 transition-all ease-in-out flex justify-center items-center relative"></div>
                            <div class="svg-container">
                                <svg class="download-icon" width="18" height="22" view-box="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path class="download-arrow" d="M13 9L9 13M9 13L5 9M9 13V1" stroke="#f59e0b" />
                                    <path d="M1 17V18C1 18.7956 1.31607 19.5587 1.87868 
                                    20.1213C2.44129 20.6839 3.20435 21 4 21H14C14.7956 21 15.5587 20.6839 16.1213 20.1213C16.6839 
                                    19.5587 17 18.7956 17 18V17"
